...
<script>
    ...
    const challengerImg = fullCards[0].imageURL.large
</script>

<!-- METADATA -->
<Meta title={data.deck.name} description={`A deck built by ${data.deck.expand.author.username}`} thumbnail={challengerImg} />
